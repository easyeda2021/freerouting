...
"%JAVA_HOME%\bin\jpackage.exe" --input "..\..\build\dist" --main-jar "freerouting-executable.jar" --name "freerouting" --type %APP_TYPE% --runtime-image "%JAVA_HOME%\runtime" --app-version %APP_VERSION% --win-per-user-install --win-menu --win-menu-group freerouting --license-file "..\..\LICENSE" --icon "..\..\assets\icon\freerouting_icon_256x256_v3.ico" --resource-dir "jpackage-resources-windows"
